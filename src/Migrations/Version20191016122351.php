...
final class Version20191016122351 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE answer_log CHANGE uuid uuid VARCHAR(255) NOT NULL');
        $this->addSql('ALTER TABLE session_log CHANGE uuid uuid VARCHAR(255) NOT NULL');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE answer_log CHANGE uuid uuid INT NOT NULL');
        $this->addSql('ALTER TABLE session_log CHANGE uuid uuid INT NOT NULL');
    }
}
